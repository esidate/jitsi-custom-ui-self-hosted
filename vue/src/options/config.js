...
export default {
  hosts: {
    ...
    muc: "conference." + subdomain + "meet.jitsi", // FIXME: use XEP-0030
  ...
  externalConnectUrl: "https://meet.jitsi/http-pre-bind",
  analytics: {
  ...
  useTurnUdp: false,
  websocket: "wss://localhost:8443/xmpp-websocket", // FIXME: use xep-0156 for that
